      ...
      <PostLayout>
        ...
        <article className='post__article'>
          <p>
            ...
            will serve both you and any team you’re working with well in the
            long run. If you often find yourself struggling to come up with a
            decent message format, or you’re unable to decipher what it was you
            were doing when looking back through old commits, this little fix
            might help. And the best part is it’s extremely easy to implement.
          </p>
          <p>
            ...
            , which makes it easy to decide how to format your messages, and
            keeps things organized across all your commits.{' '}
          ...
          <p>
            First, create a .txt file in a directory of your choice that will
            act as the template. I’ll assume you’re using the terminal for the
            process.
          </p>
          <pre>
          ...
          <p>
            You can put whatever you want in your template, but here’s mine as
            an example:
          </p>
          <pre>
            {/* prettier-ignore */}
...
<br />
          ...
          <p>
            To add the template to your global git config is enter the
            following:
          </p>
          <pre>
            <code className='codeblock'>
          ...
          <p>
            ...
            , just enter
            <code>git commit</code> to open your default editor with the
            template in place. You’ll automatically have a guide to choose
            conventions from to create a structured message. For example:
          </p>
          <pre>
            {/* prettier-ignore */}
            <code className='codeblock'>
...
git config --global core.editor "vim +16 +startinsert"<br />
          ...
          <p>
            This sets the default editor to Neovim (or Vim), and places the
            cursor on line 16 in Insert Mode as soon the editor opens. Now
            whenever you’re committing, when you type <code>git commit</code>,
            Neovim opens the template, places your cursor, and accepts typing
            input immediately. Also note that you can still use{' '}
            <code>git commit -m "Your message"</code> exactly as you did before,
            but the configuration will default to the template setup when you
          ...
          <p>
            Setting up this template has saved me countless time and
            frustration, and makes it so much easier to track my commits since
            all my repos use the same global commit format. You can get much
            more creative with git defaults and complex githooks, but this is a
            great way to solve a common problem for most developers.{' '}
          </p>
        </article>
      </PostLayout>
    </>
