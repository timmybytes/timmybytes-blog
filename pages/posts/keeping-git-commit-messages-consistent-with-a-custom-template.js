...
const NewPost = () => {
  return (
    <Post
      ...
      description='The ability to write consistent git commit messages is a skill that will serve both you and any team you’re working with well in the long run. If you often find yourself struggling to come up with a decent message format, or you’re unable to decipher what it was you were doing when looking back through old commits, this little fix might help.'
      date='January 21, 2021'>
      <p>
        The ability to write consistent git commit messages is a skill that will
        serve both you and any team you’re working with well in the long run. If
        you often find yourself struggling to come up with a decent message
        format, or you’re unable to decipher what it was you were doing when
        looking back through old commits, this little fix might help. And the
        best part is it’s extremely easy to implement.
      </p>
      <p>
      ...
      <p>
        First, create a .txt file in a directory of your choice that will act as
        the template. I’ll assume you’re using the terminal for the process.
      </p>
      <pre>
      ...
      <p>
        Open the .txt file with the editor of your choice. Git will ignore lines
        that begin with a <code>#</code> or <code>;</code> by default, so we’ll
        use those to make a template of ignored lines that only you will see
        when you’re making commits.
      </p>
...
<br />
      ...
      <p>
        ...
        , just enter
        <code>git commit</code> to open your default editor with the template in
        place. You’ll automatically have a guide to choose conventions from to
        create a structured message. For example:
      </p>
      <pre>
        {/* prettier-ignore */}
        <code className='codeblock'>
...
<br />
      ...
      <p>
        ...
        characters to ensure readability (the commented lines are 60 characters
        long and act as guides for when to use a line break). The “body”
        optionally elaborates on the changes made, and the “footer” optionally
        notes any issue/PR the commit is related to. The final message will
...
git config --global core.editor "vim +16 +startinsert"<br />
      ...
      <p>
        ...
        on line 16 in Insert Mode as soon the editor opens. Now whenever you’re
        committing, when you type <code>git commit</code>, Neovim opens the
        template, places your cursor, and accepts typing input immediately. Also
        note that you can still use <code>git commit -m "Your message"</code>{' '}
      ...
      <p>
        ...
        defaults and complex githooks, but this is a great way to solve a common
