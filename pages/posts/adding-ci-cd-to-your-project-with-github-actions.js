    ...
    <Layout>
      ...
      <article className='post__article'>
        ...
        <p>
          ...
          Events can be defined in various ways, but most typically use a git
          push to trigger an Action. By using Actions to automate tedious or
          repetitive tasks, you can make your SDLC (
...
{'      '}- run: echo "Hello" <span className='codeblock__comment'># Run a command on the runner</span>
        ...
        <p>
          ...
          creating your own scripts to run within an Action. For instance, if
...
{'      '}shell: bash<br/>
        ...
        <p>
          ...
          your workflows. Typically you only need to define the relevant action
          in your Action’s
          <code>uses:</code>
...
{'          '}NODE_AUTH_TOKEN: $&#123;&#123;secrets.NPM_AUTH_TOKEN&#125;&#125;<br />
        ...
        <p>
          ...
          useful tool that can be tailored any way you like (depending on how
          long you want to spend configuring them). I’m still getting the hang
          of implementing more complex Actions that I combine with githook
          checks locally, but I’ve found them to be a very helpful addition to
          my workflows.
        </p>
      </article>
    </Layout>
