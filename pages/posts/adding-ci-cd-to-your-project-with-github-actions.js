      ...
      <PostLayout>
        ...
        <article className='post__article'>
          <p>
            ...
            to add useful workflows to your project. In this guide, I’ll show
            you what Actions are, and how you can use them to streamline your
          ...
          <blockquote className='info'>
            ...
            development life cycle. GitHub Actions are event-driven, meaning
            that you can run a series of commands after a specified event has
            occurred.
            <br />— via{' '}
          ...
          <p>
            In the simplest sense, Actions allow you to automate tasks. That
            might include checking code for syntax errors, optimizing image
            compression, or any other task you want to automate based on a
            certain *event*. Events can be defined in various ways, but most
            typically use a git push to trigger an Action. By using Actions to
            automate tedious or repetitive tasks, you can make your SDLC (
            <a href='https://en.m.wikipedia.org/wiki/Systems_development_life_cycle'>
              Systems Development Life Cycle
            </a>
            ) more efficient, particularly when multiple people are using the
            same code base.
          </p>
...
└─ package.lock.json<br />
          ...
          <p>
            If you haven’t used YAML before, it’s very straightforward, but be
            aware the syntax is very unforgiving when it comes to whitespace.
            Make sure you’re using spaces instead of tabs for indentation.
          </p>
          <pre className='codeblock'>
            {/* prettier-ignore */}
            <code>
...
{'      '}- run: echo "Hello" <span className='codeblock__comment'># Run a command on the runner</span>
          ...
          <ol>
            ...
            <li>
              Use the community <code>actions/checkout@v2</code> Action to check
              out the repo and allow access for the current Action
            </li>
            <li>
          ...
          <p>
            So the
            <code>.yml</code>
            file provides the instructions, and the GitHub servers take care of
            all the actual heavy lifting.{' '}
          </p>
          <p>
            You’re free to run self-contained Actions in your workflow,
            including creating your own scripts to run within an Action. For
            instance, if you have a script you want to run against your repo
            written in bash, you could run that script within the workflow like
            so:
          </p>
          <pre className='codeblock'>
            {/* prettier-ignore */}
...
{'      '}shell: bash<br/>
          ...
          <p>
            There are thousands of marketplace Actions you can incorporate into
            your workflows. Typically you only need to define the relevant
            action in your Action’s
            <code>uses:</code>
            field within its YAML file, and many can be further configured
            according to their documentation.{' '}
          </p>
          <p>
            Here’s an Action I use to publish a package to the NPM repository
            only if I push to the main branch with a commit message that
            includes the word "deploy" (Note that the emojis are purely
            decorative):
          </p>
          {/* prettier-ignore */}
          <pre className='codeblock'>
...
{'          '}NODE_AUTH_TOKEN: $&#123;&#123;secrets.NPM_AUTH_TOKEN&#125;&#125;<br />
          ...
          <p>
            ...
            . So without having to do anything myself, this Action will publish
            my package to the npm registry, though it only updates the published
          ...
          <p>
            ...
            that automatically creates a Trello card with a list issues of
            issues from your repo.
          </p>
          <p>
            The capabilities are nearly limitless, depending on how much
            configuration you want to do. For example, a workflow might involve
            a few Actions that cascade:
          </p>
          <ol>
          ...
          <p>
            ...
            scenario, you might have an action that detects an issue submission,
            and prompts the user to use a premise template for their issue.
          </p>
          <p>
            Not every project will need lots of Actions, but they’re an
            extremely useful tool that can be tailored any way you like
            (depending on how long you want to spend configuring them). I’m
            still getting the hang of implementing more complex Actions that I
            combine with githook checks locally, but I’ve found them to be a
            very helpful addition to my workflows.
          </p>
        </article>
      </PostLayout>
    </>
